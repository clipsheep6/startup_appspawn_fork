...
typedef enum {
    ...
    APP_FLAGS_GWP_ENABLED_FORCE = 10,   // APP_GWP_ENABLED_FORCE 0x400
    APP_FLAGS_GWP_ENABLED_NORMAL = 11,  // APP_GWP_ENABLED_NORMAL 0x800
    APP_FLAGS_TSAN_ENABLED = 12,  // APP_TSANENABLED 0x1000
    APP_FLAGS_IGNORE_SANDBOX = 13,  // ignore sandbox result
    APP_FLAGS_ISOLATED_SANDBOX = 14,
    APP_FLAGS_EXTENSION_SANDBOX = 15,
    APP_FLAGS_CLONE_ENABLE = 16,
    APP_FLAGS_ACCESS_DOWNLOAD_DIR = 17,
    MAX_FLAGS_INDEX = 63,
} AppFlagsIndex;
